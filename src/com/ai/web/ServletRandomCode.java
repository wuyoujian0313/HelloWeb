...
@WebServlet(name = "ServletRandomCode")
public class ServletRandomCode extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String createTypeFlag = this.getServletConfig().getInitParameter("createTypeFlag");

        String tempFlag = request.getParameter("createTypeFlag");
        if (tempFlag !=null && tempFlag.length() > 0) {
            createTypeFlag = tempFlag;
        }
        //1.在内存中创建一张图片
